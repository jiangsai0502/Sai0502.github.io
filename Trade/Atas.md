...
6. 订单轨迹
   ...
   2. 失衡（Imbalance）
      ...
      2. 实战意义
         ...
         - **买方失衡带**：代表买方在该区域**主动进攻非常凶猛**，大量吃掉卖方挂单
         - **卖方失衡带**：同理，代表卖方抛压集中爆发
         - 连续失衡带：FVG，一般用3～4个连续失衡做信号
   ...
   3. POC（Point of Control / 控制点）
      ...
      2. 实战意义
         ...
         | 场景         | POC 位置   | 收盘价位置         | 含义                                                         |
         | ------------ | ---------- | ------------------ | ------------------------------------------------------------ |
         | **强势多头** | 下影线里   | 收在高位，远离 POC | 下方成交最多，但价格被强行推到高位 <br />→ **多头控盘极强**，可能是反转信号 |
         | **强势空头** | 上影线里   | 收在低位，远离 POC | 与上反之                                                     |
         | **震荡**     | 接近收盘价 | 靠近 POC           | 多空力量均衡，POC 成为短期价值共识区                         |
